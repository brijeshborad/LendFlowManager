...
export const interestEntries = pgTable("interest_entries", {
  ...
  userIdIdx: index("idx_interest_entries_user_id").on(table.userId),
  loanIdIdx: index("idx_interest_entries_loan_id").on(table.loanId),
  borrowerIdIdx: index("idx_interest_entries_borrower_id").on(table.borrowerId),
  loanPeriodIdx: index("idx_interest_entries_loan_period").on(table.loanId, table.periodStart),
}));
...
export const emailLogs = pgTable("email_logs", {
  ...
  borrowerIdIdx: index("idx_email_logs_borrower_id").on(table.borrowerId),
}));
